    ...
    'billables' => [
        ...
        'user' => [
            ...
            'plans' => [
                [
                    'name' => 'Standard',
                    'short_description' => 'Perfect for individuals and small projects',
                ...
                [
                    'name' => 'Startup',
                    'short_description' => 'Ideal for growing businesses and teams',
                    'monthly_id' => env('SPARK_STARTUP_MONTHLY_PLAN'),
                    'yearly_id' => env('SPARK_STARTUP_YEARLY_PLAN'),
                    'features' => [
                ...
                [
                    'name' => 'Enterprise',
                    'short_description' => 'For large-scale operations and enterprises',
                    'monthly_id' => env('SPARK_ENTERPRISE_MONTHLY_PLAN'),
                    'yearly_id' => env('SPARK_ENTERPRISE_YEARLY_PLAN'),
                    'features' => [
                        '1,000,000 image uploads per month',
                        'AI-powered image identification',
                        'Export results in multiple formats',
